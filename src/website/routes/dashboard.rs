                    ...
                    div {
                        ...
                        div {
                            ...
                            div {
                                ...
                                div {
                                    class: "w-8 h-8 bg-moss-500 rounded-lg flex items-center justify-center mx-auto mb-4 transition-colors",
                                    span {
                                ...
                                span {
                                    class: if mock_role == "admin" {
                                        ...
                                        "inline-flex items-center px-3 py-1 rounded-lg text-xs font-medium bg-moss-500/20 text-moss-600 border border-moss-500/30"
                                    },
                                    "{mock_role}"
                                }
                            }
                            ...
                            div {
                                ...
                                div {
                                    ...
                                    div {
                                        ...
                                        span {
                                            class: "text-2xl font-bold text-moss-500",
                                            "1,247"
                                        }
                                    }
                                    div {
                                ...
                                div {
                                    ...
                                    div {
                                        ...
                                        div {
                                            class: "bg-gradient-to-r from-green-500 to-moss-500 h-2 rounded-full",
                                            style: "width: 87.3%"
                                        }
                                    }
                                }
                                            ...
                                            div {
                                                ...
                                                span {
                                                    class: if process.status == "Running" {
                                                        "text-xs bg-green-500/20 text-green-600 px-2 py-1 rounded border border-green-500/30"
                                                    } else {
                                                        "text-xs bg-amber-500/20 text-amber-600 px-2 py-1 rounded border border-amber-500/30"
                                                    },
                                                    "{process.status}"
                                                }
                                            }
                                ...
                                div {
                                    ...
                                    div {
                                        class: if is_processing() {
                                            "w-3 h-3 bg-amber-500 rounded-full animate-gentle-float"
                                        } else {
                            ...
                            div {
                                ...
                                if chat_messages().is_empty() {
                                    div {
                                        ...
                                        div {
                                            class: "w-16 h-16 bg-moss-500/20 rounded-full flex items-center justify-center mx-auto mb-4",
                                            svg {
                                                class: "w-8 h-8 {icon_moss}",
                                                fill: "none",
                                                stroke: "currentColor",
                                                view_box: "0 0 24 24",
                                                path {
                                ...
                                for message in chat_messages() {
                                    div {
                                        ...
                                        div {
                                            class: if message.is_user {
                                                "max-w-xs lg:max-w-md bg-moss-500 text-white rounded-2xl rounded-br-md p-4"
                                            } else {
                                        ...
                                        div {
                                            ...
                                            div {
                                                ...
                                                div {
                                                    ...
                                                    div { class: "w-2 h-2 bg-moss-500 rounded-full animate-bounce" }
                                                    div { class: "w-2 h-2 bg-moss-500 rounded-full animate-bounce", style: "animation-delay: 0.1s;" }
                                                    div { class: "w-2 h-2 bg-moss-500 rounded-full animate-bounce", style: "animation-delay: 0.2s;" }
                                                }
                                                span {
                                                    class: "text-sm {text_secondary}",
                                                    "AI is thinking..."
                            ...
                            div {
                                ...
                                form {
                                    ...
                                    button {
                                        ...
                                        class: "px-6 py-3 {primary_button_bg} disabled:bg-moss-300 disabled:cursor-not-allowed {text_primary} rounded-xl transition-all duration-200 hover:scale-105 {primary_button_shadow}",
                                        if is_processing() {
                                            "Processing..."
                                        } else {
                                            "Send"
