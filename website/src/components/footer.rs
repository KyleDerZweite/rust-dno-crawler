...
pub fn Footer() -> Element {
    // Define theme-aware classes using custom color palette
    let border_color = "border-dark-charcoal-400";
    let heading_color = "text-light-beige-200";
    let text_color = "text-light-beige-500";
    let link_hover = "hover:text-forest-green-400";
    let secondary_text = "text-light-beige-600";

    rsx! {
        footer {
            class: "bg-dark-charcoal-900 border-t border-dark-charcoal-400 mt-auto",
            div {
                ...
                div {
                    ...
                    div {
                        ...
                        div {
                            ...
                            div {
                                class: "w-8 h-8 bg-forest-green-500 rounded-lg flex items-center justify-center",
                                span { class: "text-light-beige-200 font-bold text-sm", "K" }
                            }
                            h3 {
                ...
                div {
                    ...
                    div {
                        ...
                        div {
                            ...
                            span { "+" }
                            span {
                                class: "text-forest-green-400 font-medium",
                                "Dioxus"
                            }
                            span { "+" }
                            span {
